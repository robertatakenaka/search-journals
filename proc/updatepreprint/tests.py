...
class TestDocumentID(unittest.TestCase):
    ...
    def test_transform(self):
        ...
        self.assertEqual(xml.find(".//field[@name='id']"), "???")
...
class TestLanguages(unittest.TestCase):
    ...
    def test_transform_returns_pt(self):
        ...
        self.assertEqual(xml.find(".//field[@name='la']"), "pt")
    ...
    def test_transform_returns_en(self):
        ...
        data = raw, xml
        raw, xml = pipeline_xml.Languages().transform(data)
        self.assertEqual(xml.find(".//field[@name='la']"), "en")
    ...
    def test_transform_returns_es(self):
        ...
        data = raw, xml
        raw, xml = pipeline_xml.Languages().transform(data)
        self.assertEqual(xml.find(".//field[@name='la']"), "es")
...
class TestFulltexts(unittest.TestCase):
    ...
    def test_transform(self):
        ...
        self.assertEqual(
            xml.find(".//field[@name='fulltext_html_en']"),
...
class TestPublicationDate(unittest.TestCase):
    ...
    def test_transform(self):
        ...
        self.assertEqual(xml.find(".//field[@name='da']"), "2020-03-20")
...
class TestAbstract(unittest.TestCase):
    ...
    def test_transform(self):
        ...
        self.assertIsNone(xml.find(".//field[@name='ab_es']"))
        self.assertIsNone(xml.find(".//field[@name='ab_pt']"))
        self.assertIsNone(xml.find(".//field[@name='ab_fr']"))
...
class TestIsCitable(unittest.TestCase):
    def test_transform(self):
        ...
        self.assertEqual("is_true", xml.find(".//field[@name='is_citable']"))
...
class TestPermission(unittest.TestCase):
    def test_transform(self):
        ...
        self.assertEqual(
            xml.find(".//field[@name='use_license']"),
            "???"
        )
        self.assertEqual(
            xml.find(".//field[@name='use_license_text']"),
        ...
        self.assertEqual(
            xml.find(".//field[@name='use_license_uri']"),
